...
--
-- Hôte : 127.0.0.1:3306
-- Généréle :  mar. 18 juin 2019 à23:37
...
--
  ...
  --
INSERT INTO
  `competences` (`id`, `Nom`, `Niveau`, `Pourcentage`, `Droite`)
VALUES
...
VALUES
  (
    ...
    'Etudiant àYnov Informatique anciennement Ingesup visant àl\'obtention d\'un <a href=\"https://www.ynov.com/formation/ynov-masteres/expert-cloud-securite-reseaux/\"> Mastère Expert Cloud Sécurité& Infrastructure</a>.'
  ),
  (
    2,
    'S',
    '08 Janvier - 02 Février 2018 & 23 Avril - 19 Mai 2018',
    'Stage - SNCF Télécom',
    'Bordeaux Gare St Jean',
    'Stage effectuéau service télécoms de la SNCF de Bordeaux. Mise en service d\'un service de VOIP. '
  ),
  (
    3,
    'S',
    '23 Janvier - 17 Février 2017 & 06 Mars - 31 Mars 2017',
    'Stage - SNEF Connect',
    'Agence SNEF de Mérignac',
    'Stage effectuéàl\'agence SNEF de Mérignac dans le service SNEF Connect. Missions de préconfigurations de systèmes de vidéo protection pour le domaine public et privé. '
  ),
  (
    4,
    'P',
    ...
    'Première et Terminale Professionnelle SEN (Systèmes Electroniques Numériques) Obtention du Baccalauréat professionnel Systèmes électroniques numériques mention \"Bien\" en 2018. '
  ),
  (
    5,
    'G',
    '2014 - 2016',
    'Filière Générale',
    'Lycée Assomption Ste Clotilde Bordeaux',
    'Seconde Générale et Première Scientifique au Lycée Assomption Sainte Clotilde.'
  );
-- --------------------------------------------------------
  --
...
VALUES
  (
    1,
    'Infrastructure OSPF',
    'Mise en place d\'une infrastructure OSPF virtuelle.',
    'Infra / SI',
    'SI',
    'img/portfolio/tp_infra.png',
    'https://github.com/antoine33520/CCNA/blob/master/TP_6.md'
  ),
  (
    2,
    'Pong Game',
    'Réalisation d\'un jeu d\'arcade type Pong en Python3',
    'Logiciel',
    'LOG',
    'img/portfolio/pong.svg',
    'https://github.com/antoine33520/pong'
  ),
  (
    3,
    'Site Web CV',
    'Création d\'un CV sous forme de site internet avec une page d\'administration.',
    'Web',
    'WEB',
    'img/portfolio/test.png',
    'https://github.com/antoine33520/projet_cv'
  ),
  (
    4,
    'Projet Plante Connectée',
    'Projet Plante Connectée avec Raspberry Pi et Arduino',
    'Logiciel',
    'LOG',
    'img/portfolio/raspberry-pi.svg',
    'https://github.com/antoine33520/projet_plante'
  ),
  (
    5,
    'Projet Réseau',
    'Mise en place d\'une solution de routage et de VPN opensource avec Pfsense',
    'Infra / SI',
    'SI',
    'img/portfolio/pfsense.jpg',
    'https://github.com/antoine33520/projet_infra'
  ),
  (
    6,
    'Ansible / Proxmox',
    'Déploiement et provisionnement de VMs sur proxmox avec Ansible',
    'Infra / SI',
    'SI',
    'img/portfolio/Ansible_logo.svg',
    ''
  );
-- --------------------------------------------------------
  --
...
VALUES
  (
    1,
    'linkedin',
    'www.linkedin.com/in/antoine-t-717403a9'
  );
-- --------------------------------------------------------
  --
...
VALUES
  (
    ...
    'Développement',
    'Infrastructure & SI',
    'Mes compétences en developpement logiciel et web.',
