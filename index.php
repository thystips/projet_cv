        ...
        <div class="container">
            <nav class="navbar navbar-default">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html"><img id="navbar_brand-logo" src="<?php echo $logo ?>" alt="Logo" title="Logo"></a>
                </div>
                        ...
                        <div class="contact_from_area wow fadeInUp animated">
                            ...
                            <div class="row">
                                <form action="./php/contact_process.php" method="post" id="contactForm">
                                    ...
                                    <div class="form-group col-md-12">
                                        <input type="text" class="form-control" name="last" id="last" placeholder="Nom">
                                    </div>
                                    <div class="form-group col-md-12">
